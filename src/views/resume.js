    ...
    <div className="resumeContainer">
      ...
      <div className="resumeRight">
          <h1>Summary</h1>
            ...
            <h3>Experience in full stack development, testing and deployment. Passion for learning new skills and developing new applications.</h3>
            ...
            <h3>Decisive, able to make quick and effective decisions while maintaining excellent client relations and meeting deadlines. Detailed oriented team player that will go above and beyond to meet more than the expectation.</h3>
        <br></br>
          <h1>Work History</h1>
          <h2>Iron Box</h2>
